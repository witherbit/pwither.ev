## pwither.ev - Решение для вызова событий (методов) из статического класса или использования наследования от класса скрипта с использованием атрибутов для платформ .NET 7.0 и .NET 8.0
### Документация
#### Атрибуты
